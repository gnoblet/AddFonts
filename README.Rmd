...
So, let's start by going to https://fonts.bunny.net/ and picking a font. For example, let's pick "Merriweather". We can see that it has 4 variants: regular, bold, italic, and bold-italic. We can use the `preview_font()` function to see what they look like.
...
Let’s make a simple plot using the registered fonts. First, we register the fonts thanks to the marvelous `add_font()` function.
...
- see also [pyfonts](https://y-sunflower.github.io/pyfonts/) for Python by Joseph Barbier.
