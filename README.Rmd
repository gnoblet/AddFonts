...
The default provider. Supply the font family name as it appears on [fonts.bunny.net](https://fonts.bunny.net/):
...
[Bunny Fonts](https://fonts.bunny.net/) is the default provider because it mirrors most of Google Fonts with no tracking and no data collection — important for EU users and privacy-conscious projects. It has a fast global CDN and is free and open-source.
