# Session-scoped environment tracking which providers have shown their first-use message. Initialised empty; entries are written by maybe_show_first_use() and can be cleared for testing.
